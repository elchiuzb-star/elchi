...
export const T = {
  uz: {
    ...
    deleteAccount:"Hisobni o'chirish", deleteAccountAction:"O'chirish", cancel:"Bekor qilish",
    deleteAccountConfirm:"Hisobingiz o'chiriladi: ism, telefon raqami va haydovchi hujjatlari olib tashlanadi. Yakunlangan buyurtmalar hisobot uchun saqlanib qoladi. Bu amalni qaytarib bo'lmaydi.",
    deleteAccountHint:"Hisobni o'chirgach telefon raqamingiz qayta ro'yxatdan o'tish uchun bo'shaydi. Tugallanmagan buyurtma bo'lsa, avval u yakunlanishi kerak.",
  ...
  ru: {
    ...
    deleteAccount:"Удалить аккаунт", deleteAccountAction:"Удалить", cancel:"Отмена",
    deleteAccountConfirm:"Аккаунт будет удалён: имя, номер телефона и документы водителя удаляются. Завершённые заказы сохраняются для отчётности. Действие необратимо.",
    deleteAccountHint:"После удаления номер телефона освобождается для повторной регистрации. При незавершённых заказах сначала нужно их завершить.",
  ...
  en: {
    ...
    deleteAccount:"Delete account", deleteAccountAction:"Delete", cancel:"Cancel",
    deleteAccountConfirm:"Your account will be deleted: name, phone number and driver documents are removed. Completed orders are retained for reporting. This cannot be undone.",
    deleteAccountHint:"After deletion your phone number is free to register again. Any unfinished orders must be completed first.",
