...
| G9 | Xodim MFA faktorlari (kampaniya, budjet, review qarorlari real step-up talab qiladi) | ⏳ ADR-0021 Accepted; xodim faktorlari ulanmagan | finance (2), super_admin, review qiluvchi admin’da faol TOTP | super_admin | step-up bilan budjet so‘rovi | ⛔ qarorlar yopiq |
