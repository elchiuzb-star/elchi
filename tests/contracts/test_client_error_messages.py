...
V1_ONLY = {
    ...
    "DRIVER_DOCUMENT_TOO_LARGE", "CITY_INACTIVE", "DISTRICT_REQUIRED", "DISTRICT_CITY_MISMATCH",
    "DISTRICT_INACTIVE", "ROUTE_TARIFF_NOT_FOUND", "ROUTE_NOT_MATCHED", "USER_BLOCKED", "USER_INACTIVE",
}
