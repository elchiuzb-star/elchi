...
export function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-slate-50 py-10" style={{ fontFamily: "Inter, sans-serif" }}>
      <div className="mx-auto max-w-3xl px-5">
        <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm sm:p-10">
          <p className="text-xs font-semibold uppercase tracking-wide text-[#1B4FD8]">Elchi</p>
          <h1 className="mt-1.5 text-2xl font-bold text-slate-900">Maxfiylik siyosati</h1>
          <p className="mt-2 text-xs text-slate-400">Oxirgi yangilanish: {UPDATED_AT}</p>
          ...
          <Section title="2. Biz qanday ma'lumotlarni yig'amiz">
            <p className="font-medium text-slate-700">Barcha foydalanuvchilar uchun:</p>
            <List
              items={[
            ...
            <p className="pt-2 font-medium text-slate-700">Mijozlardan qo'shimcha ravishda:</p>
            <List
              items={[
            ...
            <p className="pt-2 font-medium text-slate-700">Haydovchilardan qo'shimcha ravishda:</p>
            <List
              items={[
